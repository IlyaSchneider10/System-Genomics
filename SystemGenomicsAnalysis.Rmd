...
expr_DEG_list=list(expr_DEG_BD,expr_DEG_CTRL)
...
for (set in 1:nSets)
powerTables[[set]] = list(data = pickSoftThreshold(expr_DEG_list[[set]], powerVector=powers,
verbose = 2)[[2]]);
collectGarbage();
# Plot the results:
colors = c("black", "red")
...
if (col==1)
{
legend("bottomright", legend = 'BDtry', col = colors, pch = 20) ;
} else
legend("topright", legend = 'CTRLtry', col = colors, pch = 20) ;
}
dev.off();
